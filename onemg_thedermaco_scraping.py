...
def thedermaco():
    target_url = "https://www.1mg.com/categories/featured/top-brands/the-derma-co-1950"
    ...
    with open(r'ScrapedData\TheDermaCo_1mg.txt','w',encoding='utf-8') as sourcecode:
        sourcecode.write(json.dumps(product_list, indent=4))
    print("𝑭𝒊𝒍𝒆 𝑻𝒉𝒆𝑫𝒆𝒓𝒎𝒂𝑪𝒐_1𝒎𝒈.𝒕𝒙𝒕 𝒄𝒓𝒆𝒂𝒕𝒆𝒅 𝒊𝒏 1𝒎𝒈𝒔𝒄𝒓𝒂𝒑𝒆𝒓 𝒇𝒐𝒍𝒅𝒆𝒓, 𝒄𝒉𝒆𝒄𝒌 𝒕𝒉𝒆 𝑺𝒄𝒓𝒂𝒑𝒆𝒅𝑫𝒂𝒕𝒂 𝒇𝒐𝒍𝒅𝒆𝒓")