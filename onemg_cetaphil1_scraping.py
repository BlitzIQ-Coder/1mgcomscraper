...
def cetaphil1():
    ...
    with open(r'ScrapedData\Cetaphilpage1_1mg.txt','w',encoding='utf-8') as sourcecode:
        sourcecode.write(json.dumps(product_list, indent=4))
    print("𝑭𝒊𝒍𝒆 𝑪𝒆𝒕𝒂𝒑𝒉𝒊𝒍𝒑𝒂𝒈𝒆1_1𝒎𝒈.𝒕𝒙𝒕 𝒄𝒓𝒆𝒂𝒕𝒆𝒅 𝒊𝒏 1𝒎𝒈𝒔𝒄𝒓𝒂𝒑𝒆𝒓 𝒇𝒐𝒍𝒅𝒆𝒓, 𝒄𝒉𝒆𝒄𝒌 𝒕𝒉𝒆 𝑺𝒄𝒓𝒂𝒑𝒆𝒅𝑫𝒂𝒕𝒂 𝒇𝒐𝒍𝒅𝒆𝒓")