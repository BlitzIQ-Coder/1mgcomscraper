...
def cerave():
    target_url = "https://www.1mg.com/categories/featured/top-brands/cerave-2422"
    ...
    with open(r'ScrapedData\Cerave_1mg.txt','w',encoding='utf-8') as sourcecode:
        sourcecode.write(json.dumps(product_list, indent=4))
    print("𝑭𝒊𝒍𝒆 𝑪𝒆𝒓𝒂𝒗𝒆_1𝒎𝒈.𝒕𝒙𝒕 𝒄𝒓𝒆𝒂𝒕𝒆𝒅 𝒊𝒏 1𝒎𝒈𝒔𝒄𝒓𝒂𝒑𝒆𝒓 𝒇𝒐𝒍𝒅𝒆𝒓, 𝒄𝒉𝒆𝒄𝒌 𝒕𝒉𝒆 𝑺𝒄𝒓𝒂𝒑𝒆𝒅𝑫𝒂𝒕𝒂 𝒇𝒐𝒍𝒅𝒆𝒓")